...
if (isset($_POST['add_user'])) {
    ...
    if (count($validation) === 0) {
        ...
        $query = $pdo->prepare('INSERT INTO users(username, email, password_hash, firstname, lastname, birthday, sex, role, phonenumber, license_accepted, verified) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, 1, 1)');
        $query->execute([$username, $email, $hash, $firstname, $lastname, $birthday, $sex, $role, $phonenumber]);
    echo "<br>";
    echo "<br>";
    echo "<br>";
        echo " <div class='alert alert-primary' role='alert'>User Added Successfuly</div>";
    }
} 
                ...
                <div class="col-12 col-lg-9 col-xl-7">
                    ...
                    ?>
                        ...
                        ?>
                                ...
                                <div class="mt-4 pt-2">
                                    <input name="add_user" class="btn btn-primary btn-lg" type="submit"
                                        value="Add User" />
                                </div>
